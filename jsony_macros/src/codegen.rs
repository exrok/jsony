                    ...
                    {
                        {
                            if i + 1 == variants.len() {
                                ...
                                out.buf
                                    .push(TokenTree::from(Literal::u8_unsuffixed(i as u8).clone()));
                            }
                        };
                        out.blit(607, 2);
                        {
